...
class HeadShouldersDetector(BasePatternDetector):
    ...
    def _build(self, df, ls, head, rs, is_bearish: bool, symbol, interval, atr) -> DetectedPattern:
        ...
        status = status_from_breakout(direction, current_price, neckline_now, invalidation_level, atr)
        ...
        confidence = algorithmic_confidence(
            ...
            breakout_strength=breakout_strength_score(current_price, neckline_now, atr),
            pattern_size=60.0,
        )
